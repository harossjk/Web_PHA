...
interface props {
    ...
    onChangeExport: (isClicked: boolean) => void;
}

const Filter = ({ setInquiryData, moldName, onChangeInquiry, onChangeExport }: props) => {

    const { MSMDStore, RawDataStore, UtilDataStore } = useStore();
